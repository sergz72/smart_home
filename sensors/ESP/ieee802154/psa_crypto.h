...
psa_status_t encrypt_payload_aes(int key_id, const uint8_t *payload, unsigned int payload_size, uint8_t **output, unsigned int *output_size);
psa_status_t encrypt_payload_chacha(int key_id, const uint8_t *payload, unsigned int payload_size, uint8_t **output, unsigned int *output_size);
